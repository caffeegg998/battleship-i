...
const ShipVisual = ({ length, rotated = false, direction, isSunk = false, index = 0 }: ShipVisualProps) => {
  ...
  return (
    <ShipContainer $length={length} $direction={finalDirection} $isSunk={isSunk}>
      {renderShipModel()}
    </ShipContainer>
  );
};
